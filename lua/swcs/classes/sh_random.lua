...
--if UniformRandomStream then return end
...
META.__tostring = function(self)
	return Format("UniformRandomStream [%d, %d]", self.m_idum, self.m_iy)
end

RegisterMetaTable("UniformRandomStream", META)
...
g_ursRandom = UniformRandomStream(os.time())
