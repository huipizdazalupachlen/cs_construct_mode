...
SWEP.WorldModel = Model("models/weapons/csgo/w_pist_deagle.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_pist_deagle.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/deagle.png", "smooth")
end
...
function SWEP:SetupWeaponHoldTypeForAI(t)
	...
	self.ActivityTranslate[ACT_MP_RELOAD_STAND] = ACT_HL2MP_GESTURE_RELOAD_PISTOL
	self.ActivityTranslate[ACT_MP_RELOAD_CROUCH] = ACT_HL2MP_GESTURE_RELOAD_PISTOL
