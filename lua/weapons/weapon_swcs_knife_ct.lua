...
SWEP.PrintName = "Knife (CT)"
SWEP.Spawnable = true
SWEP.HoldType = "knife"
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/knife.png", "smooth")
end

SWEP.WorldModel = Model("models/weapons/csgo/w_knife_default_ct.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_knife_default_ct.mdl")
