...
SWEP.WorldModel = Model("models/weapons/csgo/w_shot_xm1014.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_shot_xm1014.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/xm1014.png", "smooth")
end
...
function SWEP:SetupWeaponHoldTypeForAI(t)
	...
	if wOS and wOS.DynaBase and wOS.DynaBase.Registers["Vuthakral's Extended Player Animations"] then
		self.ActivityTranslate[ACT_MP_RELOAD_STAND] = ACT_GESTURE_RELOAD_SHOTGUN
		self.ActivityTranslate[ACT_MP_RELOAD_CROUCH] = ACT_GESTURE_RELOAD_SHOTGUN
	end
...
function SWEP:PrimaryAttack()
	...
	self:SetAccuracyPenalty(self:GetAccuracyPenalty(false) + self:GetInaccuracyFire(Primary_Mode))
