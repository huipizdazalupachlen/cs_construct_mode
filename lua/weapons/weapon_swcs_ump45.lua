...
if swcs.InTTT then
	...
	if CLIENT then
		SWEP.EquipMenuData = {
			type = "item_weapon",
			desc = "The misunderstood middle child of the SMG family,\nthe UMP45's small magazine is the only drawback\nto an otherwise versatile close-quarters automatic.\n\nDisorients targets.",
		}
	end
end
...
SWEP.Spawnable = true
SWEP.HoldType = "smg"
SWEP.WorldModel = Model("models/weapons/csgo/w_smg_ump45.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_smg_ump45.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/ump45.png", "smooth")
end
...
function SWEP:PostHitCallback(ent, tr)
