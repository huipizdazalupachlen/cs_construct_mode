...
SWEP.WorldModel = Model("models/weapons/csgo/w_spanner.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_spanner.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/spanner.png", "smooth")
end

SWEP.Swing1Damage = 8
SWEP.Swing2Damage = 7

SWEP.BackstabPrimaryDamage = 14
