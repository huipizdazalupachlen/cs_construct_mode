...
SWEP.WorldModel = Model("models/weapons/csgo/w_hammer.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_hammer.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/hammer.png", "smooth")
end

SWEP.Swing1Damage = 19
SWEP.Swing2Damage = 16

SWEP.BackstabPrimaryDamage = 32
