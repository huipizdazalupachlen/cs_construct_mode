...
if swcs.InTTT then
	...
	if CLIENT then
		SWEP.EquipMenuData = {
			type = "item_weapon",
			desc = "With a smaller magazine than its unmuffled\ncounterpart, the silenced M4A1 provides quieter shots\nwith less recoil and better accuracy.",
		}
	end
end
...
SWEP.Spawnable = true
SWEP.HoldType = "ar2"
SWEP.WorldModel = Model("models/weapons/csgo/w_rif_m4a1_s.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_rif_m4a1_s.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/m4a1_silencer.png", "smooth")
	SWEP.SelectIconAlt = Material("hud/swcs/select/m4a1_silencer_off.png", "smooth")
end
...
SWEP.ItemDefAttributes = [=["attributes 06/28/2022"
{
