...
SWEP.WorldModel = Model("models/weapons/csgo/w_pist_hkp2000.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_pist_hkp2000.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/hkp2000.png", "smooth")
end
...
SWEP.ItemDefAttributes = [=["attributes 07/05/2020"
{
	...
	"uid model"		"models/weapons/csgo/uid_small.mdl"
