...
SWEP.Spawnable = true
SWEP.HoldType = "ar2"
SWEP.WorldModel = Model("models/weapons/csgo/w_rif_sg556.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_rif_sg556.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/sg556.png", "smooth")
end
...
SWEP.ItemDefAttributes = [=["attributes 07/03/2020"
{
	...
	"aimsight lens mask"		"models/weapons/csgo/v_rif_sg556_scopelensmask.mdl"
	"aimsight material"			"models/weapons/shared/scope/scope_dot_red"
