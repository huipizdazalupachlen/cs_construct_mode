...
SWEP.Spawnable = true
SWEP.HoldType = "smg"
SWEP.WorldModel = Model("models/weapons/csgo/w_rif_aug.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_rif_aug.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/aug.png", "smooth")
end
...
SWEP.ItemDefAttributes = [=["attributes 07/03/2020"
{
	...
	"aimsight lens mask"		"models/weapons/csgo/v_rif_aug_scopelensmask.mdl"
	"aimsight material"			"models/weapons/shared/scope/scope_dot_green"
