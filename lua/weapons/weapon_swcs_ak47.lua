...
if swcs.InTTT then
	...
	if CLIENT then
		SWEP.EquipMenuData = {
			type = "item_weapon",
			desc = "Powerful and reliable, the AK-47 is one of the most\npopular assault rifles in the world. It is most\ndeadly in short, controlled bursts of fire.",
		}
	end
end
...
SWEP.Spawnable = true
SWEP.HoldType = "ar2"
SWEP.WorldModel = Model("models/weapons/csgo/w_rif_ak47.mdl")
SWEP.ViewModel = Model("models/weapons/csgo/v_rif_ak47.mdl")
if CLIENT then
	SWEP.SelectIcon = Material("hud/swcs/select/ak47.png", "smooth")
end
